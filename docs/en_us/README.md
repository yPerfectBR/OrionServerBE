# OrionServer Documentation (en_us)

Welcome to the English documentation hub for OrionServer.
...
- [Plugin architecture (phased spec)](plugins/README.md)
- [Project Status](project-status.md)
- [PR Guidelines](contributing/pr-guidelines.md)
- [Issue Guidelines](contributing/issue-guidelines.md)
- [AI Disclaimer](disclaimer-ai.md)
- [Credits](credits.md)

## Other Languages

- Portuguese (Brazil): [`../pt_br/README.md`](../pt_br/README.md)
