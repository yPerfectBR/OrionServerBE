# Documentação do OrionServer (pt_br)

Bem-vindo ao índice da documentação em português do OrionServer.
...
- [Arquitetura de plugins (spec por fases)](plugins/README.md)
...
- [Disclaimer sobre IA](disclaimer-ai.md)
- [Créditos](credits.md)

## Outros Idiomas

- Inglês: [`../en_us/README.md`](../en_us/README.md)
